...
export default function ManageSchools() {
  ...
  // --- ACTION LOGIC: Toggle Active/Declined ---
                  ...
                  <tr key={school.id} className="border-b border-slate-100 hover:bg-slate-50/50 transition-colors">
                    ...
                    <td className="p-4">
                      <div className="flex items-center justify-center gap-1.5">
                        ...
                        {/* NEW DELETE BUTTON */}
                        <button 
                          onClick={() => triggerDeleteModal(school)}
          ...
          <div className="bg-white rounded-2xl shadow-xl w-full max-w-md overflow-hidden animate-in zoom-in-95 duration-200 border-2 border-red-100">
            ...
            <div className="bg-red-50 p-6 flex flex-col items-center text-center border-b border-red-100">
              ...
              <p className="text-sm text-red-600 mt-2 font-medium">
                You are about to delete <span className="font-bold">"{schoolToDelete.name}"</span>. This action cannot be undone and will erase all associated data.
              </p>
            </div>

            <div className="p-6 space-y-5">
              {deleteError && (
                <div className="bg-red-50 text-red-600 text-sm font-medium p-3 rounded-lg border border-red-200 text-center">
                  {deleteError}
                </div>
              )}
              ...
              <div className="space-y-1.5">
                ...
                <input 
                  ...
                  className="w-full px-4 py-2.5 bg-slate-50 border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-100 focus:border-red-500 transition-all font-mono"
                />
              </div>
            ...
            <div className="p-4 bg-slate-50 border-t border-slate-100 flex justify-end gap-3">
              ...
              <button 
                ...
                disabled={deleteConfirmationText !== 'DELETE' || !deletePassword}
                className="bg-red-600 hover:bg-red-700 disabled:bg-red-300 disabled:cursor-not-allowed text-white px-5 py-2.5 rounded-lg font-bold transition-colors shadow-sm flex items-center gap-2"
              >
                <Trash2 size={18} />
                Permanently Delete
              </button>
            ...
            <div className="p-6 space-y-6">
              <div className="grid grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <p className="text-lg font-bold text-slate-800">{selectedSchool.student_count || 0}</p>
                </div>
              </div>
              ...
              <div className="bg-slate-50 rounded-xl p-4 border border-slate-100 space-y-4">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="font-medium text-slate-800">{selectedSchool.admin_name}</p>
                  </div>
                </div>
                <div className="flex items-center gap-3">
              ...
              <div className="flex items-center gap-2 text-sm text-slate-500 pb-2">
                ...
                <span>Onboarded on the platform: <span className="font-semibold">{new Date(selectedSchool.created_at).toLocaleDateString()}</span></span>
              </div>
            </div>
          </div>
        </div>
